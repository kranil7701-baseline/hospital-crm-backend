...
import { getHospitals, getHospitalByHospitalId, createHospital, deleteHospital, updateHospital, getHospitalsByIDN, getAllHospitalsDeals, getAllHospitalsDeals00 } from '../controller/hospital.ts';
